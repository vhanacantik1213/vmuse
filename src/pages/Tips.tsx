    ...
    <main className="min-h-screen bg-background pt-20">
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Tips & Talk</h2>
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-6 justify-between">
                  <div>
                    ...
                    <CardTitle className="text-lg font-bold mb-2">{tip.title}</CardTitle>
                    ...
                    <p className="text-sm text-muted-foreground mb-4 min-h-[64px]">{tip.excerpt}</p>
                  </div>

                  <Button className="w-full mt-auto bg-pink-500 hover:bg-pink-600 text-white rounded-lg">
                    Read Full Article
                  </Button>
                </div>
              </Card>
